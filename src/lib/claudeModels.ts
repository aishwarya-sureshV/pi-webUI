...
export function formatClaudeModelName(value: string | undefined): string {
  ...
  const title = (part: string) => part.charAt(0).toUpperCase() + part.slice(1).toLowerCase()
...
export const CLAUDE_DEFAULT_MODEL: ModelInfo = claudeModelInfo(CLAUDE_DEFAULT_MODEL_ID)!
